...
class House_Builder:
    ...
    def __init__(self, level, start_x, start_y, start_z, door, direction, wall_type):
        self.level = level
        ...
        def wallX(lv,x,y,z,door):
            ...
            if self.wall_type is 1:
                for j in range(10): #line_W
                    ...
                    if(j==0 or j==3 or j==6 or j==9):
                        for k in range(1,5): #line_H
                            setBlock(lv,x,y+k,z+j,162,0)#black
                    else:
                        if(door==1):
                            if(j==4):
                                setBlock(lv,x,y,z+j,196,0)#door
            ...
            if self.wall_type is 0:
                for j in range(9): #line_W
                    ...
                    if(j==0 or j==4 or j==8):
                        for k in range(1,5): #line_H
                            setBlock(lv, x + j, y + k, z, 162,0)#black
                    else:
                        for k in range(1,5): #line_H
                            if k==2:
                                setBlock(lv, x + j, y + k, z, 162,0)#black
                            else:
                                setBlock(lv, x + j, y + k, z, 5,4)#white
